...
namespace LuanPlatform.Core.Graphic
{
    ...
    public class Sprite
    {
        ...
        public void Init(string resName, Type resType, MemoryStream ms, Int32Rect? cutrect = null)
        {
            if (!this.IsInit)
            {
                this.ResourceName = resName;
                this.ResourceType = resType;
                Drawing.Bitmap bitmap = new Drawing.Bitmap(ms);
                bitmap.MakeTransparent(Drawing.Color.Black);
                ...
                this.SpriteBitmapImage.CacheOption = BitmapCacheOption.OnLoad;
                this.SpriteBitmapImage.StreamSource = stream;
            ...
            {
                LogUtils.Log(String.Format("Sprite Init again: {0}", resName), "MySprite", LogLevel.Error);
            }
        }
